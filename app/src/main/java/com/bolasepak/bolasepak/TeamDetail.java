...
import com.bolasepak.bolasepak.Adapter.PageAdapter;
import com.bolasepak.bolasepak.Event.MatchData;
import com.bolasepak.bolasepak.Notif.Notification;
...
public class TeamDetail extends AppCompatActivity {
    ...
    void GetIntentExtra(){
        idTeam = getIntent().getExtras().getString("id_team") ;
    ...
    void createMatchesAlarm(String idTeam) {
        ...
        Toast.makeText(TeamDetail.this, "You've subscribed to this team.", Toast.LENGTH_SHORT).
                show();
